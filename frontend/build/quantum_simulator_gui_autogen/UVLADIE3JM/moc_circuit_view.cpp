...
static constexpr auto qt_meta_stringdata_ZN11CircuitViewE = QtMocHelpers::stringData(
    "CircuitView"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11CircuitViewE[] = {
...
Q_CONSTINIT const QMetaObject CircuitView::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11CircuitViewE.offsetsAndSizes,
    qt_meta_data_ZN11CircuitViewE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11CircuitViewE_t,
        // Q_OBJECT / Q_GADGET
...
void *CircuitView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11CircuitViewE.stringdata0))
