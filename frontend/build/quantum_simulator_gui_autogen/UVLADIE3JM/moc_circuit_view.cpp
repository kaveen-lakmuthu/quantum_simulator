...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CircuitView_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CircuitView_t qt_meta_stringdata_CircuitView = {
    {
        QT_MOC_LITERAL(0, 11)   // "CircuitView"
    },
    "CircuitView"
};
...
Q_CONSTINIT static const uint qt_meta_data_CircuitView[] = {
...
Q_CONSTINIT const QMetaObject CircuitView::staticMetaObject = { {
    ...
    qt_meta_stringdata_CircuitView.offsetsAndSizes,
    qt_meta_data_CircuitView,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CircuitView_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<CircuitView, std::true_type>
    >,
    nullptr
} };
